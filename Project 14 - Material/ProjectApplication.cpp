...
void ProjectApplication::DrawCube()
{
	...
	cubeShader.SetUniformVector3("light.position", lightModelMatrix.GetPosition());
	cubeShader.SetUniformVector3("light.ambient", glm::vec3(0.2f, 0.2f, 0.2f));
	cubeShader.SetUniformVector3("light.diffuse", glm::vec3(0.5f, 0.5f, 0.5f));
	cubeShader.SetUniformVector3("light.specular", glm::vec3(0.5f, 0.5f, 0.5f));
	
	cubeShader.SetUniformVector3("material.ambient", glm::vec3(0.5f, 1.0f, 0.31f));
	cubeShader.SetUniformVector3("material.diffuse", glm::vec3(1.0f, 0.5f, 0.31f));
	cubeShader.SetUniformVector3("material.specular", glm::vec3(1.0f, 0.5f, 0.31f));
